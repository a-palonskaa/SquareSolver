...
LDFLAGS =
SOURCES = buffer_clean.cpp get_data.cpp main.cpp show_results.cpp solve_quadr.cpp compare_double.cpp test_solve_quadr.cpp test_library.cpp arg_parser.cpp
OBJ = $(SOURCES:.cpp=.o)
EXECUTABLE = square
dir = build
